...
## Limiting the forecast horizon is often a good idea because they can get  ------
## exponentially worse.
...
## Can be better for longer term forecasts that have significant trend ------
## because it does a better job of extrapolating trends vs finding & repeating 
## patterns